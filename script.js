        ...
        window.addEventListener("load", () => {
            ...
            tl.fromTo(".hero-badge",
                ...
                .fromTo(".nav-links a, .logo-container, .nav-icons a",
                    { y: -20, opacity: 0 },
        ...
        ScrollTrigger.create({
            ...
            onUpdate: (self) => {
                if (self.direction === 1) { // Scrolling down
                    ...
                    gsap.to("#navbar", { top: 0, height: "80px", backgroundColor: "rgba(255, 248, 231, 0.95)", duration: 0.3 });
                } else { // Scrolling up
                    if (window.scrollY < 50) {
                        gsap.to(".top-bar", { yPercent: 0, duration: 0.3 });
                        gsap.to("#navbar", { top: "32px", height: "96px", backgroundColor: "rgba(255, 248, 231, 0.85)", duration: 0.3 });
                    }
                }
            }
        });
        ...
        tabBtns.forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                tabPanes.forEach(p => {
                    ...
                    p.classList.add('opacity-0', 'z-0', 'pointer-events-none', 'translate-y-4');
                });
                ...
                targetPane.classList.remove('opacity-0', 'z-0', 'pointer-events-none', 'translate-y-4');
